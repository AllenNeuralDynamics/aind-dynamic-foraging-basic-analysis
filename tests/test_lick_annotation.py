...
class TestLickAnnotation(unittest.TestCase):
    ...
    def test_lick_annotation(self):
        ...
        expected_bout_start = [True, False, False, True, False, True, True, False, False, True, False, False]
        expected_bout_end = [False, False, True, False, True, True, False, False, True, False, False, True]
        expected_bout_number = [1, 1, 1, 2, 2, 3, 4, 4, 4, 5, 5, 5]
        expected_rewarded = [True, False, False, False, False, False, True, False, False, False, True, False]
        expected_bout_rewarded = [True, True, True, False, False, False, True, True, True, True, True, True]
        expected_cue_response = [True, False, False, False, False, False, False, False, False, False, False, False]
        expected_bout_cue_response= [True, True, True, False, False, False, False, False, False, False, False, False]
        expected_intertrial_choice =[False, False, False,True, False, True, True, False, False, True, False, False]
        expected_bout_intertrial_choice =[False, False, False,True, True, True, True, True, True, True, True, True]
        df = pd.DataFrame(
            {
        ...
        df = pd.DataFrame(
            {
                "timestamps": times + cue_times,
                "data": [1.0] * (len(times) + len(cue_times)),
                "event": ["left_lick_time", "left_lick_time", "left_lick_time","left_lick_time","goCue_start_time"],
                "trial": [1] * (len(times) + len(cue_times)),
            }
        )
        df = df.sort_values(by="timestamps")
